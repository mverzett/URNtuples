// -*- C++ -*-
//
// Package:    URNtuples/NtupleGenParticleInheritance.cc
// Class:      NtupleGenParticleInheritance.cc
// 
/**\class NtupleGenParticleInheritance.cc NtupleGenParticleInheritance.cc.cc URNtuples/NtupleGenParticleInheritance.cc/plugins/NtupleGenParticleInheritance.cc.cc
